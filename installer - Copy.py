...
GAME_URL = "https://github.com/SquareCircleGames/Honey_Catcher_500_Follower_Special/releases/download/1.0Linux/Linux.Build.zip"

ZIP_NAME = "LinuxBuild.zip"
EXTRACT_DIR = "HoneyCatcherSCG"
LAUNCHER_NAME = "honeycatcher.x86_64"

def main():
    print("--- Honey Catcher Linux Installer ---\n")
